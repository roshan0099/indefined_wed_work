    ...
    return (
        <>
            ...
            <div className=' bg-cover bg-center h-screen relative text-yellow-50' style={{ backgroundImage: `url(${coverImg})` }}>
                <div className={` fixed mt-16 z-50 h-full w-full ${infoClick ? 'opacity-100 backdrop-blur-2xl bg-opacity-10 ' : 'transform -translate-x-32 opacity-0 pointer-events-none'}  ${isScrolled && 'text-black'} transition-all ease-in-out duration-700 flex flex-col items-center p-12 gap-11`}>
                    ...
                    <div>
                        ...
                        <div className='text-3xl'>
                            on 3rd August, 2024 at 11:00 AM - 2:00 PM
                        </div>
                        ...
                        <div className='mt-6'>
                            <a className='border rounded-lg p-2' href="https://maps.app.goo.gl/wNsV1i17dZdTSB3BA?g_st=ic">See it on the Map</a>
                        </div>
                ...
                <div style={overlayStyle} className='grid grid-rows-5 auto-rows-auto'>
                    ...
                    <div className='p-4 md:pl-9 lg:row-start-3 md:row-start-1 row-span-1 break-words text-wrap w-full'>
                        <div className='md:text-4xl text-2xl'>We are tying the knot,</div>
                        <div className='text-7xl md:text-9xl break-words'> NAZRIN &nbsp;&&nbsp;<br />HAROON</div>

                    </div>

                    <div className='row-start-5 flex flex-row justify-between text-lg p-4 md:p-20 md:text-3xl'>
                        <div className=''>
                            3rd August, 2024 at <br />
                            11:00 AM - 2:00 PM
                        </div>
